...
const contract = JSON.parse(fs.readFileSync(path.join(root, 'contracts', 'manifest-v5.lock.json'), 'utf8'));
...
const sourceMaterial = [
  ...
  fs.readFileSync(path.join(root, 'contracts', 'manifest-v5.lock.json'), 'utf8'),
